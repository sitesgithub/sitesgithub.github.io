    ...
    var Menu = new Class({
        ...
        generate: function(parent) {
            ...
            this.url = GameGlobals.path('intermediate.html?url=' +
                encodeURIComponent(getGlobalNamespace().KICKASSURL || document.location.href) + "&preship=" + (shipId) + "&is_campaign=" + (this.game.isCampaign() ? "true" : "") + "&is_mysite=" + (this.game.isMySite() ? "true" : ""));
